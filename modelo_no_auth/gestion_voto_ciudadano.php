<?PHP
	...
	class voto_ciudadano(){
		...
		function insertar_voto($mysqli, $id_propuesta, $id_ciudadano, $voto){
			$estatus=1;
			...
			$stm->bind_param("iiii",$id_propuesta, $id_ciudadano, $voto);
			$stm->execute();
			$id_propuesta_votacion_ciudadano=-$mysqli->insert_id;
			$stm->close();
