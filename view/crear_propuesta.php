<link href="../css/dropzone.min.css" type="text/css" rel="stylesheet"/>
		<div class="col-md-8">
			<h3><span class='nombreSistema'>Nueva Propuesta <small class="numero_formulario">PARTE 1</small></span></h3>
		</div>
		<div class="col-md-2">
							...
							<div class = "panel-body">
								<div class="row">
									...
									<div class="form-group col-md-10">
										<label for="txt_titulo_propuesta">Titulo</label>
										<input type="text" class="form-control" id="txt_titulo_propuesta" autofocus="">
									</div>
									<div class="col-md-1"></div>
								</div>
								<div class="row">
						...
						<div class = "panel panel-default">
							...
							<div class = "panel-body">
								<div class="row">
									<div class="col-md-2"></div>
									<div class="col-md-8">
										<label for="txt_id_tema">Se relaciona la problematica con eel tema</label><br/>
										<div class="col-md-6">
											<div class="form-group">
